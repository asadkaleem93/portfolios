...
router.post('/setUser', multipartMiddleware, async (apiRequest, apiResponse) => {
  ...
  //       query = 'INSERT INTO user_info(email, user_name, phone_number, degree, university, gpa_score, resume) VALUES (${email}, ${user_name}, ${phone_number}, ${degree}, ${university}, ${score}, ${resume}) returning ${email};'
  ...
  //   query = 'INSERT INTO user_info(email, user_name, phone_number, degree, university, gpa_score ) VALUES (${email}, ${user_name}, ${phone_number}, ${degree}, ${university}, ${score}) returning ${email};'
  //   dbConnection.one(query, updatedData)
  //   .then((res) => {
  //     apiResponse.send({
